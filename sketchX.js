...
class Resources{
  constructor() {
    ...
    this.final=loadImage('Final.png');
...
function SetFinalText(result){
  ...
  textSize(20);
  textAlign(CENTER);
  image(resources.final,width/2-width/4,height/2+height/2/2.9-height/2,width/2,height/2);
  text('Твой результат: '+result, width/2,(height/2+height/2/2.9-height/2)/2);
}
